...
```{r country-list}
country_list <- c("United Kingdom of Great Britain and Northern Ireland", "Russian Federation", 
                  "Mexico", "Turkey")
```
...
un_votes %>%
  filter(country %in% c("United Kingdom of Great Britain and Northern Ireland", "Turkey")) %>%
  inner_join(un_roll_calls, by = "rcid") %>%
